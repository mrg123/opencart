<?php  
class ControllerOnePagePaymentMethod extends Controller {
  	public function index() {
		...
		if (empty($this->session->data['payment_methods'])) {
			if (!isset($this->session->data['payment_country_id'])) {
				...
				$this->data['error_warning'] = 'Waiting: ' . $this->data['text_checkout_payment_address']; //ADD
			}else{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepage/payment_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/onepage/payment_method.tpl';
		} else {
			$this->template = 'default/template/onepage/payment_method.tpl';
		}
